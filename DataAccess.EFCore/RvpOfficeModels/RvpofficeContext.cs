...
namespace DataAccess.EFCore.RvpOfficeModels
{
    public partial class RvpofficeContext : DbContext
    {
        ...
        public virtual DbSet<InvoicehdLog> InvoicehdLog { get; set; }
...
");
            ...
            modelBuilder.Entity<InvoicehdLog>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("invoicehd_log");
                ...
                entity.Property(e => e.BranchUpdate)
                    .HasMaxLength(50)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.RecordComment)
                    .HasColumnName("recordComment")
                    .HasMaxLength(500)
                    .IsUnicode(false);
