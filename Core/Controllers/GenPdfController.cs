...
namespace Core.Controllers
{
    ...
    public class GenPdfController : ControllerBase
    {
        ...
        //    var pdfSigned = await SignPdfByByte(file);

        //    var ds = Convert.FromBase64String(pdfSigned);

        //    if (pdfSigned != null)
        //    {
        //        return File(ds, "application/pdf");
        //    }
        //    else
        //    {
        ...
        //private async Task<string> SignPdfByByte(byte[] unSignedPdf)
        //{
